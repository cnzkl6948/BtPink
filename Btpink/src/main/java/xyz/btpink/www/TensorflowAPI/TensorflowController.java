...
//				System.out.println("이메일 전송");
				...
				final String username = "btpink.seo";  //네이버 아이디를 입력해주세요. @nave.com은 입력하지 마시구요. 
				final String password = "rhkrwjd87";  //네이버 이메일 비밀번호를 입력해주세요. 
				int port=465; //포트번호 
				
				// 메일 내용 
				String recipient = sensei.getEmail();  //받는 사람의 메일주소를 입력해주세요. 
				String subject = sensei.getName() + " 先生クラスを確認してください。"; //메일 제목 입력해주세요. 
				String body = "人数の変動が起こりました。現在人数 : "+count+"人です。"; //메일 내용 입력해주세요. 
				...
				//MimeMessage 생성 
				mimeMessage.setFrom(new InternetAddress("btpink.seo@gmail.com")); //발신자 셋팅 , 보내는 사람의 이메일주소를 한번 더 입력합니다. 이때는 이메일 풀 주소를 다 작성해주세요. 
