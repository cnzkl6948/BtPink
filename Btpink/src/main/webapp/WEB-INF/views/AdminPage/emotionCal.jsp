      ...
      <section class="content">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body">
              ...
              <div id="external-events">
                <div class="col-xs-6 external-event bg-mimm"><a href="javascript:getEmotionList('21');">학생1</a></div>
