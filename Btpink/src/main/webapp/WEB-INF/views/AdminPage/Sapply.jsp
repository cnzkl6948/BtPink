...
<div class="content-wrapper">
	...
	<section class="col-lg-6 connectedSortable">
		<div class="col-lg-12">
          ...
          <div class="box box-danger">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="formId" action="Sapply" method="POST" role="form" enctype="multipart/form-data" >
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="classno" name="classno" placeholder="반 이름">
                  </div>
                  <label for="height" class="col-sm-2 control-label">키</label>
                  <div class="col-sm-3">
                    <input type="text" class="form-control" id="height" name="height" placeholder="키(cm)">
                  </div>
                </div>
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="checkbox">
							<label><input type="checkbox">O X</label>
						</div>
					</div>
				</div>
				<div class="form-group">
	...
	<section class="col-lg-6 connectedSortable">
		<div class="col-md-12">
	              ...
	              <div class="box-group" id="accordion">
	                ...
	                <div class="panel box box-primary">
	                  ...
	                  <div id="collapseOne" class="panel-collapse collapse in">
	                    <div class="box-body">
	                      	&nbsp;이 메뉴는 학생을 등록하는 메뉴입니다. 출석체크를 위해 사진 업로드가 필요합니다.	             	
	                    </div>
	                  </div>
	                </div>
	                ...
	                <div class="panel box box-success">
	                  ...
	                  <div id="collapseThree" class="panel-collapse collapse in">
	                    <div class="box-body">
	                     	 ◎ 등록된 사진을 이용해서 출석체크합니다.<br>
	                     	 ◎ 안경을 쓴 학생은 체크해주세요. 자리배치 시 필요한 정보입니다.
	                    </div>
	                  </div>
	                </div>
	              </div>
	          ...
	          <!-- /.box -->
	          <button type="button" class="btn btn-block btn-danger" data-toggle="modal" data-target="#modal-danger" onclick="submit()">
                	등록
              </button>
	          <button type="button" class="btn btn-block btn-default" onclick="cancel()">
                	취소
              </button>
