        ...
        <div class="row">
          <div class="col-sm-4 col-xs-12">
            <div class="teamContent teamAdjust">
              <div class="teamImage">
              <img src="./resources/img/home/team/team-1.jpg" alt="img" class="img-circle img-responsive">
          ...
          <div class="col-sm-4 col-xs-12">
            <div class="teamContent teamAdjust">
              <div class="teamImage">
              <img src="./resources/img/home/team/team-2.jpg" alt="img" class="img-circle img-responsive">
                <div class="maskingContent">
                  <ul class="list-inline">
                    <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                    <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
          ...
          <div class="col-sm-4 col-xs-12">
            <div class="teamContent teamAdjust">
              <div class="teamImage">
              <img src="./resources/img/home/team/team-3.jpg" alt="img" class="img-circle img-responsive">
                <div class="maskingContent">
                  <ul class="list-inline">
                    <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                    <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
...
<!--                 <img class="img-rounded img-responsive" src="img/home/team/team-1.jpg" alt="Image"> -->
<!--               </a> -->
<!--               <div class="media-body"> -->
<!--                 <h4 class="media-heading"><a href="#">Amanda Stone</a></h4> -->
<!--                 <h5>English Teacher</h5> -->
<!--                 <p>They must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you.</p> -->
<!--                 <ul class="list-inline"> -->
...
<!--             <div class="media teamStyle"> -->
<!--               <a class="media-left" href="#"> -->
<!--                 <img class="img-rounded img-responsive" src="img/home/team/team-2.jpg" alt="Image"> -->
<!--               </a> -->
<!--               <div class="media-body"> -->
<!--                 <h4 class="media-heading"><a href="#">Amanda Stone</a></h4> -->
<!--                 <h5>English Teacher</h5> -->
...
<!--             <div class="media teamStyle"> -->
<!--               <a class="media-left" href="#"> -->
<!--                 <img class="img-rounded img-responsive" src="img/home/team/team-3.jpg" alt="Image"> -->
<!--               </a> -->
<!--               <div class="media-body"> -->
<!--                 <h4 class="media-heading"><a href="#">Amanda Stone</a></h4> -->
<!--                 <h5>English Teacher</h5> -->
...
<!--             <div class="media teamStyle"> -->
<!--               <a class="media-left" href="#"> -->
<!--                 <img class="img-rounded img-responsive" src="img/home/team/team-4.jpg" alt="Image"> -->
<!--               </a> -->
<!--               <div class="media-body"> -->
<!--                 <h4 class="media-heading"><a href="#">Amanda Stone</a></h4> -->
<!--                 <h5>English Teacher</h5> -->
      ...
      <div class="row">
        <div class="col-sm-3 col-xs-12">
          <div class="footerTitle">
            <a href="/www"><img src="./resources/img/logo-footer.png"></a>
          </div>
