...
<head>
  ...
  <title>Bus Finder - Parents</title>
      ...
      <div class="container">
       ...
       <div class="sectionTitle text-center">
          <h2>
            ...
            <span>Bus Current Location</span>
       ...
       <div class="row">
          ...
          <div class="col-sm-4 col-xs-12">
            <div class="media addressContent">
              <span class="media-left bg-color-3" href="writeDemand">
                <i class="fa fa-envelope-o" aria-hidden="true"></i>
              </span>
              <div class="media-body">
                <h3 class="media-heading">출석변동사항:</h3>
                <p><a href="writeDemand">writeDemand</a> 
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-xs-12">
          <div class="footerTitle">
            <a href="index.html"><img src="./resources/img/logov3.png"></a>
          </div>
...
<script src="./resources/plugins/google-custom-map/google-map.js"></script>
