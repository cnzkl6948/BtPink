...
<body class="body-wrapper">
	...
	<div class="main-wrapper">
						...
						<li data-transition="fade" data-slotamount="5"
							...
							<div class="slider-caption container">
								<div class="tp-caption rs-caption-1 sft start text-center"
									...
									data-endspeed="300">Sell Kids Products</div>
								...
								<div class="tp-caption rs-caption-2 sft text-center"
									...
									All ecommerce features are included with KIDZ <br> Build
									your ecommerce site.
								</div>
							</div></li>
						<li data-transition="fade" data-slotamount="5"
							...
							<div class="slider-caption container">
								<div class="tp-caption rs-caption-1 sft start text-right"
									...
									data-start="1000" data-easing="Back.easeInOut"
									data-endspeed="300">Impress Your Clients</div>

								<div class="tp-caption rs-caption-2 sft text-right"
									data-hoffset="0" data-y="265" data-x="right" data-speed="1000"
									data-start="1500" data-easing="Power4.easeOut"
									data-endspeed="300" data-endeasing="Power1.easeIn"
									data-captionhidden="off">Kidz is created for better user
									experience in mind.</div>
							</div></li>
						<li data-transition="fade" data-slotamount="5"
							data-masterspeed="1000" data-title="Slide 2"><img
							src="./resources/img/home/slider/slider-4.jpg" alt="slidebg1"
							data-bgfit="cover" data-bgposition="center center"
							data-bgrepeat="no-repeat">
							<div class="slider-caption container">
								<div class="tp-caption rs-caption-1 sft start text-center"
									data-hoffset="0" data-x="center" data-y="200" data-speed="800"
									data-start="1000" data-easing="Back.easeInOut"
									data-endspeed="300">Bright Playful Colors</div>
					...
					<div class="row">
						<div class="col-sm-3">
							<a href="#ourCourses" class="sectionLink bg-color-1"
								...
								aria-hidden="true"></i> <span class="linkText">Courses</span> <i
						...
						<div class="col-sm-3">
							<a href="#ourTeam" class="sectionLink bg-color-2" id="teamLink">
								...
								aria-hidden="true"></i> <span class="linkText">Teachers</span> <i
								class="fa fa-chevron-down locateArrow" aria-hidden="true"></i>
							</a>
						</div>
						<div class="col-sm-3">
							<a href="#ourGallery" class="sectionLink bg-color-3"
								id="galleryLink"> <i
								class="fa fa-picture-o linkIcon border-color-3"
								aria-hidden="true"></i> <span class="linkText">Gallery</span> <i
								class="fa fa-chevron-down locateArrow" aria-hidden="true"></i>
							</a>
						</div>
						<div class="col-sm-3">
							<a href="#latestNews" class="sectionLink bg-color-4"
								id="newsLink"> <i
								class="fa fa-files-o linkIcon border-color-4" aria-hidden="true"></i>
								<span class="linkText">News</span> <i
								class="fa fa-chevron-down locateArrow" aria-hidden="true"></i>
							</a>
						</div>
					</div>
		...
		<section class="mainContent full-width clearfix featureSection">
			<div class="container">
				<div class="sectionTitle text-center">
					<h2>
						<span class="shape shape-left bg-color-4"></span> <span>Our
							Features</span> <span class="shape shape-right bg-color-4"></span>
					</h2>
				</div>
				...
				<div class="row">
					...
					<div class="col-sm-4 col-xs-12">
						<div class="media featuresContent">
							<span class="media-left bg-color-4"> <i
								class="fa fa-cutlery bg-color-4" aria-hidden="true"></i>
							</span>
							<div class="media-body">
					...
					<div class="col-sm-4 col-xs-12">
						<div class="media featuresContent">
							<span class="media-left bg-color-5"> <i
								class="fa fa-heart bg-color-5" aria-hidden="true"></i>
							</span>
							<div class="media-body">
					...
					<div class="col-sm-4 col-xs-12">
						<div class="media featuresContent">
							<span class="media-left bg-color-6"> <i
								class="fa fa-shield bg-color-6" aria-hidden="true"></i>
							</span>
							<div class="media-body">
			...
			<div class="container">
				<div class="promotionInfo">
					...
					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed
						do eiusmod</p>
					<a href="contact-us.html" class="btn btn-primary"><i
		...
		<div class="row">
			<div class="col-sm-3 col-xs-12 block">
				<div class="thumbnail thumbnailContent">
					...
					<div class="caption border-color-1">
						<h3>
							<a href="course-single-left-sidebar.html" class="color-1">Morbi
								scelerisque nibh.</a>
						</h3>
						...
						<ul class="list-inline btn-yellow">
							<li><a href="cart-page.html" class="btn btn-primary "><i
									class="fa fa-shopping-basket " aria-hidden="true"></i>Add to
									Cart</a></li>
							<li><a href="course-single-left-sidebar.html"
			...
			<div class="col-sm-3 col-xs-12 block">
				<div class="thumbnail thumbnailContent">
					...
					<div class="caption border-color-2">
						<h3>
							<a href="course-single-left-sidebar.html" class="color-2">Phasellus
								convallis eros.</a>
						</h3>
						<ul class="list-unstyled">
							<li><i class="fa fa-calendar-o" aria-hidden="true"></i>Age 2
			...
			<div class="col-sm-3 col-xs-12 block">
				<div class="thumbnail thumbnailContent">
					...
					<div class="caption border-color-3">
						<h3>
							<a href="course-single-left-sidebar.html" class="color-3">Suspendisse
								a libero da.</a>
						</h3>
						<ul class="list-unstyled">
							<li><i class="fa fa-calendar-o" aria-hidden="true"></i>Age 2
			...
			<div class="col-sm-3 col-xs-12 block">
				<div class="thumbnail thumbnailContent">
					<a href="course-single-left-sidebar.html"><img
						src="./resources/img/home/courses/course-4.jpg" alt="image"
						class="img-responsive"></a>
					<div class="sticker bg-color-4">$50</div>
					<div class="caption border-color-4">
						<h3>
							<a href="course-single-left-sidebar.html" class="color-4">Aenean
								cursus urna nec.</a>
						</h3>
						<ul class="list-unstyled">
							<li><i class="fa fa-calendar-o" aria-hidden="true"></i>Age 2
	...
	<section
		...
		<div class="container">
			<div class="sectionTitle text-center alt">
				<h2>
					<span class="shape shape-left bg-color-3"></span> <span>Meet
						Our Teachers</span> <span class="shape shape-right bg-color-3"></span>
				</h2>
			</div>
	...
	<!-- WHITE SECTION -->
	<section class="whiteSection full-width clearfix homeGallerySection"
		id="ourGallery">
		<div class="container">
			<div class="sectionTitle text-center">
				<h2>
					<span class="shape shape-left bg-color-4"></span> <span>Our
						Gallery</span> <span class="shape shape-right bg-color-4"></span>
				</h2>
			</div>
			...
			<div class="row isotopeContainer" id="container">
				<div class="col-md-3 col-sm-6 col-xs-12 isotopeSelector charity">
					<article class="">
						<figure>
							<img src="./resources/img/home/home_gallery/gallery_sm_1.jpg"
							...
							<div class="overlay">
								<a class="fancybox-pop" rel="portfolio-1"
									href="img/home/home_gallery/gallery_lg_1.jpg"> <i
				...
				<div class="col-md-3 col-sm-6 col-xs-12 isotopeSelector nature">
					<article class="">
						<figure>
							<img src="./resources/img/home/home_gallery/gallery_sm_2.jpg"
								alt="image" class="img-rounded">
							<div class="overlay-background">
								<div class="inner"></div>
							</div>
							<div class="overlay">
								<a class="fancybox-pop" rel="portfolio-1"
									href="img/home/home_gallery/gallery_lg_2.jpg"> <i
									class="fa fa-search-plus" aria-hidden="true"></i>
								</a>
							</div>
						</figure>
				...
				<div class="col-md-3 col-sm-6 col-xs-12 isotopeSelector nature">
					<article class="">
						<figure>
							<img src="./resources/img/home/home_gallery/gallery_sm_3.jpg"
								alt="image" class="img-rounded">
							<div class="overlay-background">
								<div class="inner"></div>
							</div>
							<div class="overlay">
								<a class="fancybox-pop" rel="portfolio-1"
									href="img/home/home_gallery/gallery_lg_3.jpg"> <i
									class="fa fa-search-plus" aria-hidden="true"></i>
								</a>
							</div>
						</figure>
				...
				<div class="col-md-3 col-sm-6 col-xs-12 isotopeSelector charity">
					<article class="">
						<figure>
							<img src="./resources/img/home/home_gallery/gallery_sm_4.jpg"
								alt="image" class="img-rounded">
							<div class="overlay-background">
								<div class="inner"></div>
							</div>
							<div class="overlay">
								<a class="fancybox-pop" rel="portfolio-1"
									href="img/home/home_gallery/gallery_lg_4.jpg"> <i
									class="fa fa-search-plus" aria-hidden="true"></i>
								</a>
							</div>
						</figure>
				...
				<div class="col-md-3 col-sm-6 col-xs-12 isotopeSelector nature">
					<article class="">
						<figure>
							<img src="./resources/img/home/home_gallery/gallery_sm_5.jpg"
								alt="image" class="img-rounded">
							<div class="overlay-background">
								<div class="inner"></div>
							</div>
							<div class="overlay">
								<a class="fancybox-pop" rel="portfolio-1"
									href="img/home/home_gallery/gallery_lg_5.jpg"> <i
									class="fa fa-search-plus" aria-hidden="true"></i>
								</a>
							</div>
						</figure>
				...
				<div class="col-md-3 col-sm-6 col-xs-12 isotopeSelector children">
					<article class="">
						<figure>
							<img src="./resources/img/home/home_gallery/gallery_sm_6.jpg"
								alt="image" class="img-rounded">
							<div class="overlay-background">
								<div class="inner"></div>
							</div>
							<div class="overlay">
								<a class="fancybox-pop" rel="portfolio-1"
									href="img/home/home_gallery/gallery_lg_6.jpg"> <i
									class="fa fa-search-plus" aria-hidden="true"></i>
								</a>
							</div>
						</figure>
				...
				<div class="col-md-3 col-sm-6 col-xs-12 isotopeSelector children">
					<article class="">
						<figure>
							<img src="./resources/img/home/home_gallery/gallery_sm_7.jpg"
								alt="image" class="img-rounded">
							<div class="overlay-background">
								<div class="inner"></div>
							</div>
							<div class="overlay">
								<a class="fancybox-pop" rel="portfolio-1"
									href="img/home/home_gallery/gallery_lg_7.jpg"> <i
									class="fa fa-search-plus" aria-hidden="true"></i>
								</a>
							</div>
						</figure>
				...
				<div class="col-md-3 col-sm-6 col-xs-12 isotopeSelector children">
					<article class="">
						<figure>
							<img src="./resources/img/home/home_gallery/gallery_sm_8.jpg"
								alt="image" class="img-rounded">
							<div class="overlay-background">
								<div class="inner"></div>
							</div>
							<div class="overlay">
								<a class="fancybox-pop" rel="portfolio-1"
									href="img/home/home_gallery/gallery_lg_8.jpg"> <i
									class="fa fa-search-plus" aria-hidden="true"></i>
								</a>
							</div>
						</figure>
	...
	<section class="whiteSection full-width clearfix newsSection"
		...
		<div class="container">
			<div class="sectionTitle text-center">
				<h2>
					<span class="shape shape-left bg-color-4"></span> <span>Latest
						News</span> <span class="shape shape-right bg-color-4"></span>
				</h2>
			</div>
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12 block">
					<div class="thumbnail thumbnailContent">
						<a href="single-blog-left-sidebar.html"><img
						...
						<div class="caption border-color-1">
							<h3>
								<a href="single-blog-left-sidebar.html" class="color-1">The
									standard chunk of Lorem.</a>
							</h3>
							<ul class="list-inline">
								<li><a href="single-blog-left-sidebar.html"><i
										class="fa fa-user" aria-hidden="true"></i>Jone Doe</a></li>
								<li><a href="single-blog-left-sidebar.html"><i
										class="fa fa-comments-o" aria-hidden="true"></i>4 Comments</a></li>
							</ul>
							<p>Contrary to popular belief, Lorem Ipsum is not simply
								random text. It has roots in a piece of classi cal Latin
								literature.</p>
							<ul class="list-inline btn-yellow">
								<li><a href="single-blog-left-sidebar.html"
									class="btn btn-link"><i class="fa fa-angle-double-right"
										aria-hidden="true"></i> Read More</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="col-sm-4 col-xs-12 block">
					<div class="thumbnail thumbnailContent">
						<a href="single-blog-left-sidebar.html"><img
							src="./resources/img/home/news/news-2.jpg" alt="image"
							class="img-responsive"></a>
						...
						<div class="caption border-color-2">
							<h3>
								<a href="single-blog-left-sidebar.html" class="color-2">Vestibulum
									congue massa vitae.</a>
							</h3>
							<ul class="list-inline">
								<li><a href="single-blog-left-sidebar.html"><i
										class="fa fa-user" aria-hidden="true"></i>Jone Doe</a></li>
				...
				<div class="col-sm-4 col-xs-12 block">
					<div class="thumbnail thumbnailContent">
						<a href="single-blog-left-sidebar.html"><img
							src="./resources/img/home/news/news-3.jpg" alt="image"
							class="img-responsive"></a>
						<div class="sticker-round bg-color-3">
							10 <br>July
						</div>
						<div class="caption border-color-3">
							<h3>
								<a href="single-blog-left-sidebar.html" class="color-3">Curabitur
									ac nulla sodales risus.</a>
							</h3>
							<ul class="list-inline">
								<li><a href="single-blog-left-sidebar.html"><i
										class="fa fa-user" aria-hidden="true"></i>Jone Doe</a></li>
			...
			<div class="row">
				<div class="col-sm-6 col-xs-12">
					<div class="homeContactContent">
						...
						<address>
							<p>
								<i class="fa fa-map-marker bg-color-1" aria-hidden="true"></i>9/4/C
								Ring Road,Garden Street Dhaka,Bangladesh-1200
							</p>
							<p>
								<i class="fa fa-envelope bg-color-2" aria-hidden="true"></i><a
						...
						<form action="#" method="POST" role="form">
							<div class="form-group">
								<i class="fa fa-user"></i> <input type="text"
									class="form-control border-color-1" id="exampleInputEmail1"
						...
						<div class="footerInfo">
							<ul class="list-unstyled footerList">
								...
								<li><a href="photo-gallery.html"> <i
										class="fa fa-angle-double-right" aria-hidden="true"></i> Photo
										Gallery
								</a></li>
							</ul>
						</div>
...
<!-- 						<form action="#" method="POST" role="form"> -->
<!-- 							<div class="form-group formField"> -->
<!-- 								<input type="text" class="form-control" placeholder="Heres"> -->
<!-- 							</div> -->
<!-- 							<div class="form-group formField"> -->
<!-- 								<input type="text" class="form-control" placeholder="asdfasdfa"> -->
<!-- 							</div> -->
<!-- 							<div class="form-group formField"> -->
<!-- 								<input type="text" class="form-control" placeholder="sadfsadfsad"> -->
<!-- 							</div> -->
<!-- 							<div class="form-group formField"> -->
<!-- 									<input type="password" class="form-control" -->
<!-- 										placeholder="Password"> -->
